...
export default function App() {
  ...
  // Sync resolve results into display state and history
  const prevGeojsonRef = useState<GeoJSON.Feature | null>(null);
  if (geojson && geojson !== prevGeojsonRef[0]) {
    prevGeojsonRef[1](geojson);
